...
<head>
    ...
    <meta name="description" content="WSO2 Cloud SAML Sample - Login">

    <title>WSO2 Cloud SAML Sample - Login</title>
...
<%--                    <img src="img/wso2-cloud.svg" class="login-img"/>--%>
                </div>
                <div class="app-name text-center">WSO2 Cloud</div>
                <p class="lead text-muted text-center">SAML Sample</p>
